...
const lol = "need some word\n💘enthelum ezhuthu nenba"
    ...
    Asena.addCommand({ pattern: 'Shazz ?(.*)', fromMe: true,dontAddCommandList: true}, (async (message, match) => {
    ...
    Asena.addCommand({ pattern: 'Shazz ?(.*)', fromMe: false,dontAddCommandList: true}, (async (message, match) => {
