...
if (Config.WORKTYPE == 'private') {
  ...
  var topText, bottomText;
   ...
   await message.client.sendMessage(message.jid,Buffer.from(webimage.data), MessageType.image, {mimetype: Mimetype.jpg, caption: '😈𝕄𝕒𝕕𝕖 𝕓𝕪 𝕊ℍ𝔸ℤℤ😈'})
    ...
    Asena.addCommand({pattern: 'logomaker', fromMe: false, desc: EFFECT_DESC}, (async (message, match) => {    
  ...
  var topText, bottomText;
   ...
   await message.client.sendMessage(message.jid,Buffer.from(webimage.data), MessageType.image, {mimetype: Mimetype.jpg, caption: '😈𝕄𝕒𝕕𝕖 𝕓𝕪 𝕊ℍ𝔸ℤ😈'})
